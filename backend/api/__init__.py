...
def all_routes():
    from . import (admin_routes, ansible_routes, auth_routes, client_routes, compute_routes,
                   dashboard_routes, device_routes, morning_update_routes, nac_routes, push_routes,
                   vpn_endpoints)
    modules = (auth_routes, admin_routes, push_routes, device_routes,
               dashboard_routes, client_routes, nac_routes, vpn_endpoints,
               compute_routes, ansible_routes, morning_update_routes)
